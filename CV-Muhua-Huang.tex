...
\subsection*{AI Simulation}
\begin{enumerate}[label={[\arabic*]}]
    \item \myname{Huang, M.}, \& Evans, J. (2026). Institutions as cached computation for resource-rational negotiation. \textit{Behavioral and Brain Sciences}, 49, e144. \href{https://doi.org/10.1017/S0140525X2510174X}{DOI}
\end{enumerate}

\subsection*{AI Character and Value Alignment}
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item Bai, Y., Duan, S., \myname{Huang, M.}, Yao, J., Liu, Z., Zhang, P., \ldots \& Xie, X. (2026). IROTE: Human-like Traits Elicitation of Large Language Model via In-Context Self-Reflective Optimization. \textit{Proceedings of the AAAI Conference on Artificial Intelligence}. \href{https://doi.org/10.1609/aaai.v40i36.40252}{DOI}
...
\noindent\textbf{Student Researcher} $|$ Google DeepMind \hfill 2026.6 -- 2026.9\\[0.3em]

\noindent\textbf{Contributing Researcher and Writer} $|$ Stanford HAI \& Google DeepMind \hfill 2026
\begin{itemize}
    \item Partnered with Martin Gonzalez on conceptualization, research, and writing for \href{https://storage.googleapis.com/deepmind-media/research/organizing-intelligence/organizing-intelligence-research-primer.pdf}{\textit{Organizing Intelligence}}, a 16-topic research primer on AI and organizations; publicly acknowledged in the report.
\end{itemize}

\noindent\textbf{Research Intern} $|$ Microsoft Research Asia \hfill 2024.7 -- 2024.10\\
\noindent\advisor{Dr. Xiaoyuan Yi and Dr. Xing Xie}\\
\noindent\project{On the Dynamics of LLMs' Values as a Community}
\begin{itemize}
    \item Built a scalable multi-agent platform with cognitive modules, RAG, and parallel processing to model value evolution in LLM communities.
    \item Designed experiments on value diversity, population size, and time; used social network analysis, GraphRAG, and NLP to study networks and emergent language, culture, and institutions.
\end{itemize}
\end{minipage}
...
\begin{itemize}[itemsep=4pt]
    ...
    {\scriptsize \textit{APA}, Seattle (Aug 2024, Poster); \textit{CPA}, St.\ John's (Jun 2025, w/ X. Zhang); \textit{CPA}, Montréal (Jun 2026, w/ X. Zhang); \textit{ISDSA}, Beijing (Jul 2026, Speed Talk, w/ X. Zhang)}
    ...
    {\scriptsize \textit{APA}, Washington DC (Aug 2023, Poster); \textit{IMPS}, Minneapolis (Jul 2025, w/ J. Sun); \textit{CPA}, Montréal (Jun 2026)}
