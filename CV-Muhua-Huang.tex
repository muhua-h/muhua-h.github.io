...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item Bai, Y., Duan, S., \myname{Huang, M.}, Yao, J., Liu, Z., Zhang, P., \ldots \& Xie, X. (2026). IROTE: Human-like Traits Elicitation of Large Language Model via In-Context Self-Reflective Optimization. \textit{Proceedings of the AAAI Conference on Artificial Intelligence}. [\href{https://arxiv.org/abs/2508.08719}{Preprint}]
...
%----------------------------------------------------------------------------------------
\section*{Research \& Writing Contributions}

\noindent\textbf{Contributing Researcher and Writer} $|$ Stanford HAI \& Google DeepMind \hfill 2026\\
\href{https://storage.googleapis.com/deepmind-media/research/organizing-intelligence/organizing-intelligence-research-primer.pdf}{\textit{Organizing Intelligence: 16 Big Ideas from Frontier AI Research That Will Redefine How We Build, Lead, and Scale}}\\
Publicly acknowledged for partnership in the primer's conceptualization and research.
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item Zhang, H., \myname{Huang, M.}, \& Wang, J. (Under Review). Computational Multi-Agents Society Experiments: Social Modeling Framework Based on Generative Agents. [\href{https://arxiv.org/abs/2508.17366}{Preprint}]

    \item Kim, H., Yi, X., Yao, J., \myname{Huang, M.}, Bak, J., Evans, J., \& Xie, X. (Under Review). Research on Superalignment Should Advance Now with Parallel Optimization of Competence and Conformity. [\href{https://arxiv.org/abs/2503.07660}{Preprint}]
