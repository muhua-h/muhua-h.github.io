...
<div class="section-tabs" role="tablist" aria-label="Profile sections">
  ...
  <button class="section-tab" id="tab-internships" type="button" role="tab" aria-selected="false" aria-controls="panel-internships" tabindex="-1" data-tab-target="panel-internships" data-tab-hash="internships">Internships</button>
